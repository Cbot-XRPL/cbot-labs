...
function getAppPayload() {
  ...
  return {
    brand: {
      ...
      summary: "We run infrastructure and ship products for the XRPL ecosystem — from a mainnet Xahau UNL validator and a free public cluster to oneXah, native DeFi app.",
      logo: "/ll.png"
    },
    validator: {
